...
perSliceH = round((goalPos(3)-startPos(3))/sliceNum);
slice = struct;
...
savefig("exp/ACA_final_fig") 
save("exp/ACA_GlobalBest.mat","GlobalBest")
save("exp/ACA_fitness_beat_iters.mat","fitness_beat_iters")
%% 结果展示
% 画适应度迭代图

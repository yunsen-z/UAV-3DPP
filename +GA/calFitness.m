function pop = calFitness(startPos, goalPos, X,Y,Z, pop, intrp_num)
for i = 1:size(pop,2)
    % 对种群中的每个个体进行遍历，size(pop,2)是popNum
    
    % 将当前染色体中的路线和起始点相连接，然后利用三次样条拟合散点
